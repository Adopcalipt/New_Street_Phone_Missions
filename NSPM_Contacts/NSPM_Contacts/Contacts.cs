...
namespace NSPM_Contacts
{
    public class Contacts : Script
    {
        ...
        private void NSPMCoinAccount()
        {
            ...
            if (!DataStore.bMenuOpen && !DataStore.bBuildMode && !MissionData.bOnTheJob)
            {
        ...
        public string ImportsExpo_CarList(int iVechList)
        {
            ...
            if (iVechList == 1)
            {
                ...
                int iCar = RandomNum.RandInt(0, sVehicles.Count - 1);
            ...
            {
                int iCar = RandomNum.RandInt(0, sCustomCarz.Count - 1);
