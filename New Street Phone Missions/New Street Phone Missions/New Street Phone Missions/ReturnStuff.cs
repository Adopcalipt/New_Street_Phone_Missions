    ...
    public class ReturnStuff 
    {
        ...
        public static string ImportsExpo_CarList(int iVechList)
        {
            ...
            if (iVechList == 1)
            {
                ...
                int iCar = RandomNum.FindRandom(43, 0, sVehicles.Count - 1);
            ...
            else if (iVechList == 2)
            {
                ...
                int iCar = RandomNum.FindRandom(44, 0, sVehicles.Count - 1);
                sThisVehicle = sVehicles[iCar];
            }       //Coupe
            else if (iVechList == 3)
            {
                ...
                int iCar = RandomNum.FindRandom(45, 0, sVehicles.Count - 1);
                sThisVehicle = sVehicles[iCar];
            }       //Sport
            else if (iVechList == 4)
            {
                ...
                int iCar = RandomNum.FindRandom(46, 0, sVehicles.Count - 1);
                sThisVehicle = sVehicles[iCar];
            }       //Mussle
            else if (iVechList == 5)
            {
                ...
                int iCar = RandomNum.FindRandom(47, 0, sVehicles.Count - 1);
                sThisVehicle = sVehicles[iCar];
            }       //SportsClassic
            else if (iVechList == 6)
            {
                ...
                int iCar = RandomNum.FindRandom(48, 0, sVehicles.Count - 1);
                sThisVehicle = sVehicles[iCar];
            }       //Compact
            else if (iVechList == 7)
            {
                ...
                int iCar = RandomNum.FindRandom(49, 0, sVehicles.Count - 1);
                sThisVehicle = sVehicles[iCar];
            }       //Sedan
            else if (iVechList == 8)
            {
                ...
                int iCar = RandomNum.FindRandom(50, 0, sVehicles.Count - 1);
                sThisVehicle = sVehicles[iCar];
            }       //Offroad
            else if (iVechList == 9)
            {
                ...
                int iCar = RandomNum.FindRandom(51, 0, sVehicles.Count - 1);
                sThisVehicle = sVehicles[iCar];
            }       //SUV
            else
            {
                ...
                int iCar = RandomNum.FindRandom(58, 0, sVehicles.Count - 1);
                sThisVehicle = sVehicles[iCar];
            }
        ...
        public static string RandNPC(int iRando)
        {
            ...
            {
                if (sPeds.Count > 1)
                    sPedds = sPeds[RandomNum.RandInt(0, sPeds.Count - 1)];
                else
                    sPedds = sPeds[0];
            }
            else
        ...
        public static List<string> DanceList(bool bMale, int iSpeed)
        {
            ...
            if (bMale)
            {
                if (iSpeed == 1)
                {
                    int iRand = RandomNum.RandInt(0, MaleDance01.Count - 1);
                    sDancing.Add(MaleDance01[iRand].DanceType);
                    sDancing.Add(MaleDance01[iRand].Dance);
                }
                else if (iSpeed == 2)
                {
                    int iRand = RandomNum.RandInt(0, MaleDance02.Count - 1);
                    sDancing.Add(MaleDance02[iRand].DanceType);
                    sDancing.Add(MaleDance02[iRand].Dance);
                }
                else
                {
                    int iRand = RandomNum.RandInt(0, MaleDance03.Count - 1);
                    sDancing.Add(MaleDance03[iRand].DanceType);
                    sDancing.Add(MaleDance03[iRand].Dance);
                }
            }
            else
            {
                if (iSpeed == 1)
                {
                    int iRand = RandomNum.RandInt(0, FemaleDance01.Count - 1);
                    sDancing.Add(FemaleDance01[iRand].DanceType);
                    sDancing.Add(FemaleDance01[iRand].Dance);
                }
                else if (iSpeed == 2)
                {
                    int iRand = RandomNum.RandInt(0, FemaleDance02.Count - 1);
                    sDancing.Add(FemaleDance02[iRand].DanceType);
                    sDancing.Add(FemaleDance02[iRand].Dance);
                }
                else
                {
                    int iRand = RandomNum.RandInt(0, FemaleDance03.Count - 1);
                    sDancing.Add(FemaleDance03[iRand].DanceType);
                    sDancing.Add(FemaleDance03[iRand].Dance);
                }
            }
        ...
        public static int PedWalkies(Ped Peddy, List<Vector3> MyLister, int iLocalList)
        {
            ...
            TheMissions.WalkThisWay(Peddy, MyLister[iReturnInt], 1.00f);
        ...
        public static bool PedRunToFoward(Ped Peddy, List<Vector3> MyLister, int iLocal, float fSpeed)
        {
            ...
            if (iLocal < MyLister.Count)
                TheMissions.WalkThisWay(Peddy, MyLister[iLocal], fSpeed);
            else
                bInUse = false;
        ...
        public static string RanVehListX(int iVechList, int iType, bool bAddCustom)
        {
            ...
            if (iType == 5)
            {
                ...
                sCar = MyCarz[RandomNum.RandInt(0, MyCarz.Count - 1)];
            }
            else
            {
        ...
        {
            UiDisplay.ButtonDisabler(CButt);
