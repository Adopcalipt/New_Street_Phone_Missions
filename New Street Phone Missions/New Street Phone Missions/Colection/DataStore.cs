...
namespace New_Street_Phone_Missions
{
    public class DataStore 
    {
        ...
        public static List<string> sGateList { get; set; }

        public static List<string> LangXLists { get; set; }

        public static List<Vector3> vOldPhoneBoxList { get; set; }
        public static List<Vector3> AppMadness { get; set; }
        ...
        public static void OnLoadup()
        {
            LoggerLight.LogThis("OnLoadup " + DataStore.sVersion);

            Function.Call(Hash.SET_PAUSE_MENU_ACTIVE, false);

            Function.Call(Hash.SET_RELATIONSHIP_BETWEEN_GROUPS, 0, DataStore.GP_Player, DataStore.GP_ANPCs);
            Function.Call(Hash.SET_RELATIONSHIP_BETWEEN_GROUPS, 0, DataStore.GP_ANPCs, DataStore.GP_Player);
            ...
            Function.Call(Hash.SET_RELATIONSHIP_BETWEEN_GROUPS, 5, DataStore.GP_BNPCs, DataStore.GP_Player);
            Function.Call(Hash.SET_RELATIONSHIP_BETWEEN_GROUPS, 5, DataStore.GP_Player, DataStore.GP_BNPCs);

            Function.Call(Hash.SET_RELATIONSHIP_BETWEEN_GROUPS, 5, DataStore.GP_Mental, DataStore.GP_Mental);

            Function.Call(Hash.SET_RELATIONSHIP_BETWEEN_GROUPS, 5, DataStore.GP_ANPCs, DataStore.GP_BNPCs);
            Function.Call(Hash.SET_RELATIONSHIP_BETWEEN_GROUPS, 5, DataStore.GP_BNPCs, DataStore.GP_ANPCs);

            if (File.Exists("" + Directory.GetCurrentDirectory() + "/Menyoo.asi") && DataStore.MySettings.PreLoadOnline)
                DataStore.MySettings.MenyooAppFixer = true;
            else
                DataStore.MySettings.MenyooAppFixer = false;
            ...
            UI.Notify("New Street Phone Missions " + DataStore.sVersion + " by ~b~Adopocalipt ~w~Loaded.");

            ObjectHand.ReadWriteBlips(true, false, -1, -1, -1, -1, -1, -1);
        ...
        public static Lingoo LingoReturns()
        {
        ...
        public static XmlSetings XmlSetReturn()
        {
        ...
        public static List<string> LangFiles()
        {
            LoggerLight.LogThis("LangFiles");

            List<string> Langa = new List<string>();

            Langa.Add("LangReader");
            Langa.Add("" + Directory.GetCurrentDirectory() + "/Scripts/NSPM/Language/English.Xml");
            Langa.Add("" + Directory.GetCurrentDirectory() + "/Scripts/NSPM/Language/Chinese.Xml");
            Langa.Add("" + Directory.GetCurrentDirectory() + "/Scripts/NSPM/Language/ChineseS.Xml");
            Langa.Add("" + Directory.GetCurrentDirectory() + "/Scripts/NSPM/Language/French.Xml");
            Langa.Add("" + Directory.GetCurrentDirectory() + "/Scripts/NSPM/Language/German.Xml");
            Langa.Add("" + Directory.GetCurrentDirectory() + "/Scripts/NSPM/Language/Italian.Xml");
            Langa.Add("" + Directory.GetCurrentDirectory() + "/Scripts/NSPM/Language/Japanese.Xml");
            Langa.Add("" + Directory.GetCurrentDirectory() + "/Scripts/NSPM/Language/Korean.Xml");
            Langa.Add("" + Directory.GetCurrentDirectory() + "/Scripts/NSPM/Language/Spanish.Xml");
            Langa.Add("" + Directory.GetCurrentDirectory() + "/Scripts/NSPM/Language/Polish.Xml");
            Langa.Add("" + Directory.GetCurrentDirectory() + "/Scripts/NSPM/Language/Portuguese.Xml");
            Langa.Add("" + Directory.GetCurrentDirectory() + "/Scripts/NSPM/Language/Russian.Xml");
            Langa.Add("" + Directory.GetCurrentDirectory() + "/Scripts/NSPM/Language/Spanish.Xml");

            return Langa;
        }
        public static PlayerAssets SetMyAss()
        {
            LoggerLight.LogThis("SetMyAss");

            PlayerAssets PlayAss = new PlayerAssets();

            if (DataStore.MyDatSet.iOwnaYacht == DataStore.iProcessForYacht)
                PlayAss.OwnaYacht = true;

            if (DataStore.MyDatSet.iGotPegsus == DataStore.iProcessForPegs)
                PlayAss.GotPegsus = true;

            if (DataStore.MyDatSet.iPegsSafeHeliTest == DataStore.iPegsSafeHeli)
                PlayAss.PegsSafeHeliTest = true;

            if (DataStore.MyDatSet.iPegsWarHeliTest == DataStore.iPegsWarHeli)
                PlayAss.PegsWarHeliTest = true;

            if (DataStore.MyDatSet.iPegsSafePlaneTest == DataStore.iPegsSafePlane)
                PlayAss.PegsSafePlaneTest = true;

            if (DataStore.MyDatSet.iPegsWarPlaneTest == DataStore.iPegsWarPlane)
                PlayAss.PegsWarPlaneTest = true;

            if (DataStore.MyDatSet.iPegsboatsTest == DataStore.iPegsboats)
                PlayAss.PegsboatsTest = true;

            if (DataStore.MyDatSet.iPegsimortasTest == DataStore.iPegsimortas)
                PlayAss.PegsimortasTest = true;

            if (DataStore.MyDatSet.iMeddicTest == DataStore.iMeddicc)
                PlayAss.MeddicTest = true;

            if (DataStore.MyDatSet.iWantedBribe > 0)
                PlayAss.WantedBribe = true;

            if (DataStore.MyDatSet.iFubard > 0)
                PlayAss.Fubard = true;

            return PlayAss;
        }
        public static List<string> PhonesTypes()
        {
            LoggerLight.LogThis("PhonesTypes");

            List<string> Phoney = new List<string>();
            Phoney.Add("p_phonebox_02_s");
            Phoney.Add("prop_phonebox_04");
            Phoney.Add("prop_phonebox_03");
            Phoney.Add("prop_phonebox_02");
            Phoney.Add("prop_phonebox_01c");
            Phoney.Add("prop_phonebox_01b");
            Phoney.Add("prop_phonebox_01a");
            Phoney.Add("p_phonebox_01b_s");

            return Phoney;
        }
        public static List<Vector3> PhoneOff()
        {
        ...
        public static List<string> TheDoors()
        {
            LoggerLight.LogThis("TheDoors");

            List<string> Dorry = new List<string>();

            Dorry.Add("prop_ld_bankdoors_02");
            Dorry.Add("v_ilev_247door");
            Dorry.Add("v_ilev_247door_r");
            Dorry.Add("v_ilev_bank4door01");
            Dorry.Add("v_ilev_bank4door02");
            Dorry.Add("v_ilev_bl_doorsl_l");
            Dorry.Add("v_ilev_bl_doorsl_r");
            Dorry.Add("v_ilev_bs_door");
            Dorry.Add("v_ilev_ch_glassdoor");
            Dorry.Add("v_ilev_clothmiddoor");
            Dorry.Add("v_ilev_cor_darkdoor");
            Dorry.Add("v_ilev_cor_darkdoor");
            Dorry.Add("v_ilev_cor_doorglassa");
            Dorry.Add("v_ilev_cor_doorglassb");
            Dorry.Add("v_ilev_cs_door01");
            Dorry.Add("v_ilev_cs_door01_r");
            Dorry.Add("v_ilev_csr_door_l");
            Dorry.Add("v_ilev_csr_door_r");
            Dorry.Add("v_ilev_csr_door_r");
            Dorry.Add("v_ilev_gasdoor");
            Dorry.Add("v_ilev_gasdoor_r");
            Dorry.Add("v_ilev_gc_door03");
            Dorry.Add("v_ilev_gc_door04");
            Dorry.Add("v_ilev_genbankdoor1");
            Dorry.Add("v_ilev_genbankdoor2");
            Dorry.Add("v_ilev_hd_door_l");
            Dorry.Add("v_ilev_hd_door_r");
            Dorry.Add("v_ilev_ml_door1");
            Dorry.Add("v_ilev_ph_door002");
            Dorry.Add("v_ilev_ph_door01");
            Dorry.Add("v_ilev_po_door");
            Dorry.Add("v_ilev_ra_door1_l");
            Dorry.Add("v_ilev_ra_door1_r");
            Dorry.Add("v_ilev_stad_fdoor");
            Dorry.Add("v_ilev_ta_door");
            Dorry.Add("v_ilev_ss_door5_r");
            Dorry.Add("v_corp_hicksdoor");
            Dorry.Add("prop_strip_door_01");
            Dorry.Add("hei_v_ilev_bk_gate_pris");
            Dorry.Add("h4_prop_h4_gate_l_03a");
            Dorry.Add("h4_prop_h4_gate_r_03a");
            Dorry.Add("prop_strip_door_01");
            Dorry.Add("sm_14_mp_door_l");
            Dorry.Add("prop_map_door_01");
            Dorry.Add("prop_sm1_11_doorl");
            Dorry.Add("prop_control_rm_door_01");
            Dorry.Add("prop_magenta_door");
            Dorry.Add("prop_sc1_12_door");
            Dorry.Add("v_ilev_deviantfrontdoor");
            Dorry.Add("ch_prop_casino_door_01a");
            Dorry.Add("ch_prop_ch_service_door_02c");
            Dorry.Add("ch_prop_ch_service_door_02b");
            Dorry.Add("ch_prop_ch_service_door_02a");
            Dorry.Add("ch_prop_casino_door_01b");
            Dorry.Add("ch_prop_casino_door_01c");
            Dorry.Add("ch_prop_ch_gendoor_01");

            return Dorry;
        }
        public static List<string> TheGates()
        {
            LoggerLight.LogThis("TheGates");

            List<string> Dorry = new List<string>();

            Dorry.Add("prop_gate_prison_01");
            Dorry.Add("prop_gate_docks_ld");
            Dorry.Add("prop_facgate_01");
            Dorry.Add("prop_facgate_01b");
            Dorry.Add("prop_fnclink_06gate2");
            Dorry.Add("prop_facgate_04_l");
            Dorry.Add("prop_facgate_04_r");

            return Dorry;
        }
        public static List<Vector3> AppyNess()
        {
            LoggerLight.LogThis("AppyNess");

            List<Vector3> V4Me = new List<Vector3>();

            V4Me.Add(new Vector3(346.5659f, -1012.851f, -99.19622f));
            V4Me.Add(new Vector3(260.5322f, -999.1339f, -99.0087f));//"Low End Apartment"),
            V4Me.Add(new Vector3(343.8500f, -999.0800f, -99.1977f));//"Mid Range Apartment"),
            V4Me.Add(new Vector3(-262.46f, -951.89f, 75.83f));//"3 Alta Street Apt 10"),
            V4Me.Add(new Vector3(-280.74f, -961.50f, 91.11f));//"3 Alta Street Apt 57"),
            V4Me.Add(new Vector3(-895.85f, -433.90f, 94.06f));//"Weazel Plaza Apt 26"),
            V4Me.Add(new Vector3(-909.054f, -441.466f, 120.205f));//"Weazel Plaza Apt 70"),
            V4Me.Add(new Vector3(-884.301f, -454.515f, 125.132f));//"Weazel Plaza Apt 101"),
            V4Me.Add(new Vector3(-897.197f, -369.246f, 84.0779f));//"Richard Majestic Apt 4"),
            V4Me.Add(new Vector3(-932.29f, -385.88f, 108.03f));//"Richard Majestic Apt 51"),
            V4Me.Add(new Vector3(-575.305f, 42.3233f, 92.2236f));//"Tinsel Towers Apt 29"),
            V4Me.Add(new Vector3(-617.609f, 63.024f, 106.624f));//"Tinsel Towers Apt 45"),
            V4Me.Add(new Vector3(-795.04f, 342.37f, 206.22f));//"Eclipse Towers Apt 5"),
            V4Me.Add(new Vector3(-759.79f, 315.71f, 175.40f));//"Eclipse Towers Apt 9"),
            V4Me.Add(new Vector3(-797.095f, 335.069f, 158.599f));//"Eclipse Towers Apt 31"),
            V4Me.Add(new Vector3(-752.605f, 320.821f, 221.855f));//"Eclipse Towers Apt 40"),
            V4Me.Add(new Vector3(-37.41f, -582.82f, 88.71f));//"4 Integrity Way Apt 30"),
            V4Me.Add(new Vector3(-10.58f, -581.26f, 98.83f));//"4 Integrity Way Apt 35"),
            V4Me.Add(new Vector3(-1477.14f, -538.75f, 55.5264f));//"Del Perro Heights Apt 7"),
            V4Me.Add(new Vector3(-1474.17f, -528.124f, 68.1541f));//"Del Perro Heights Apt 20"),
            V4Me.Add(new Vector3(-14.7964f, -581.709f, 79.4307f));//"4 Integrity Way Apt 28"),
            V4Me.Add(new Vector3(-1468.14f, -541.815f, 73.4442f));//"Del Perro Heights Apt 4"),
            V4Me.Add(new Vector3(-915.811f, -379.432f, 113.675f));//"Richard Majestic Apt 2"),
            V4Me.Add(new Vector3(-614.86f, 40.6783f, 97.6001f));//"Tinsel Towers Apt 42"),
            V4Me.Add(new Vector3(-773.407f, 341.766f, 211.397f));//"Eclipse Towers Apt 3"),
            V4Me.Add(new Vector3(-172.983f, 494.033f, 137.654f));//"3655 Wild Oats Drive"),
            V4Me.Add(new Vector3(340.941f, 437.18f, 149.39f));//"2044 North Conker Avenue"),
            V4Me.Add(new Vector3(373.023f, 416.105f, 145.701f));//"2045 North Conker Avenue"),
            V4Me.Add(new Vector3(-676.127f, 588.612f, 145.17f));//"2862 Hillcrest Avenue"),
            V4Me.Add(new Vector3(-763.107f, 615.906f, 144.14f));//"2868 Hillcrest Avenue"),
            V4Me.Add(new Vector3(-857.798f, 682.563f, 152.653f));//"2874 Hillcrest Avenue"),
            V4Me.Add(new Vector3(120.5f, 549.952f, 184.097f));//"3677 Whispymound Drive"),
            V4Me.Add(new Vector3(-1288.0f, 440.748f, 97.6946f));//"2113 Mad Wayne Thunder"),

            return V4Me;
        }
        public static CustomVeh FindCustomCarz()
        {
