...
namespace New_Street_Phone_Missions
{
    public class DataStore
    {
        ...
        public static int GP_ANPCs = World.AddRelationshipGroup("GroupA");
        public static int GP_BNPCs = World.AddRelationshipGroup("GroupB");
        public static int GP_Attack = World.AddRelationshipGroup("AttackNPCs");
        public static int GP_Mental = World.AddRelationshipGroup("MentalNPCs");

        public static readonly string sVersion = "4.20";
        ...
        public static readonly string sWardFold = "" + Directory.GetCurrentDirectory() + "/Scripts/NSPM/Wardrobe/";
        ...
        public static void DataStoreLoad()
        {
            ...
            MaleCloth = new List<ClothBank>();
            FemaleCloth = new List<ClothBank>();
        ...
        private static XmlSetings XmlSetReturn()
        {
            ...
            if (NewSet.ModVersion != 401)
            {
                NewSet.ModVersion = 401;
